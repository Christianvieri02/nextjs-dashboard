...
import { registerUserAction, fetchUsersAction } from '../../lib/actions';
                    ...
                    <td className="py-4 px-6 text-center">
                      <div className="flex items-center justify-center gap-2">
                        <button 
                          ...
                          className={`p-1.5 rounded transition-all ${isSystemAdmin ? 'text-gray-700 cursor-not-allowed' : 'text-gray-400 hover:text-white hover:bg-gray-800'}`}
                          title="Edit User"
                        >
                        ...
                        <button 
                          suppressHydrationWarning
                          disabled={isSystemAdmin}
                          className={`p-1.5 rounded transition-all ${isSystemAdmin ? 'text-gray-700 cursor-not-allowed' : 'text-gray-400 hover:text-red-400 hover:bg-red-500/10'}`}
                          title="Hapus User"
                        >
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2">
